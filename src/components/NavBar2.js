      ...
      <nav className="navbar navbar-expand-sm navbar-dark">
        <div className="container">
            ...
            <ul className="navbar-nav ml-5">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#">Class Calendar</a>
                </li>
                <li className="nav-item">
                    <a className="nav-link" href="#">Class News</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Global<span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a class="nav-text" href="#">Classes</a></li>
                        <li><a class="nav-text" href="#">Gradebook</a></li>
                        <li><a class="nav-text" href="#">Messages</a></li>
                    </ul>
                </li>
            </ul>
            <div class="navbar-nav ml-auto mini-nav">
